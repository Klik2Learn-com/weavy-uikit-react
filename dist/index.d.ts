...
declare const MessengerProvider: ({ children }: Props$1) => React.JSX.Element;
...
declare const ConversationBadge: () => React.JSX.Element;

declare const ConversationList: () => React.JSX.Element;
...
declare const _default: React.MemoExoticComponent<({ id, showBackButton, features }: ConversationProps) => React.JSX.Element>;
...
declare const Chat: ({ uid, className, features }: ChatProps) => React.JSX.Element;
...
declare const Posts: ({ uid, className, features }: PostsProps) => React.JSX.Element;
...
declare const Files: ({ uid, className, view: initView, order: initOrder, trashed: initTrashed, features }: FilesProps) => React.JSX.Element;
